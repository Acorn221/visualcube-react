...
function getCubeOutlineGroup(svg: SVG.Doc, options: ICubeOptionsComplete): SVG.G {
...
function renderCubeOutline(svg: SVG.G, face: FaceStickers, options: ICubeOptionsComplete): SVG.Polygon {
...
function renderFaceStickers(svg: SVG.Doc, face: Face, stickers: FaceStickers, options: ICubeOptionsComplete): SVG.G {
 ...
 */
function getStickerColor(face: Face, row: number, col: number, options: ICubeOptionsComplete): string {
